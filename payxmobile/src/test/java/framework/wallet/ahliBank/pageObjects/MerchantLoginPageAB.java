...
public class MerchantLoginPageAB extends AppPageInit {
    public MerchantLoginPageAB() {
        super();
    }
    ...
    public MerchantLoginPageAB clickOnUATServer(){
    ...
    public MerchantLoginPageAB acceptBiometricAlert(){
        clickOnElement(alertBioAccept,"Biometic alert accept");
        return this;
    }

    public MerchantLoginPageAB rejectBiometricAlert(){
        isElementNotPresent(alertBioReject);
        clickOnElement(alertBioReject,"Biometic alert reject");
        return this;
    }

    public MerchantLoginPageAB clickOnLoginButton(){
    ...
    public MerchantLoginPageAB clickOnOk(){
        clickOnElement(btnOk,"Okay Button");
        return this;
    }

    public MerchantLoginPageAB setMobileNumber(String msisdn){
        editMobNumber.clear();
        setText(editMobNumber,msisdn,"Mobile Number");
        return this;
    }

    public MerchantLoginPageAB setPin(String pin){
        editMPIN.clear();
    ...
    public MerchantLoginPageAB clickOnVerifyOtp(){
    ...
    public MerchantLoginPageAB clickOnSubmitButton(){

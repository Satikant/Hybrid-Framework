package tests.mobiquityPayX.DBXP;

import common.Assertion;
import framework.mobiquityPayX.DBXP.features.dbxpLoginFeature;
...
public class dbxpLoginTest extends TestInit {

    dbxpLoginFeature loginFeature = new dbxpLoginFeature();
    DBXPLoginPageObjects loginPage = new DBXPLoginPageObjects();
    ...
    public void Login001() {
        ...
        loginFeature.login(GenerateRandomValue.getRandomIntValueWithPrefix(8,"00"), GenerateRandomValue.getRandomIntValue(0));
